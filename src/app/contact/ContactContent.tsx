      ...
      <section className={styles.pageHero}>
        <div className="container">
          ...
          >
            ...
            <h1 className="heading-xl">Let&apos;s Create Something<br /><span className="text-accent">Beautiful Together</span></h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className={styles.grid}>
            ...
            <ScrollReveal direction="left">
              <div className={styles.infoCol}>
                <h2 className="heading-sm">We&apos;d Love to Hear From You</h2>
                <p className={styles.infoText}>
                  Whether you&apos;re looking for the perfect gift, planning a corporate event,
                  or just curious about our plants — we&apos;re here to help.
                </p>
              ...
              <div className={styles.formCard}>
                ...
                <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
                  ...
                  <select className={styles.input} defaultValue="">
                    ...
                    <option>Custom Planters</option>
                    <option>Other</option>
                  </select>
                  <textarea rows={4} placeholder="Tell us more..." className={styles.textarea} />
